                           ...
                           <h3 class="text-center">Iniciar sesión</h3>
                            <form method="POST" action="<?php echo e(route('login')); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputMail" type="email" class="form-control form-control-sm" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus placeholder="ejemplo@ejemplo.com">
                                </div>
...
<?php /**PATH C:\xampp\htdocs\cliente\resources\views/auth/login.blade.php ENDPATH**/ ?>